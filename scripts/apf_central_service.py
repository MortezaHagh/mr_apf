...
class Robot(object):
    def __init__(self, model, xs=0, ys=0, id=0, name="r", heading=0, xt=0, yt=0):
        self.id = id
        self.xs = xs
        self.ys = ys
        self.xt = xt
...
class InitRobotService(object):
    def __init__(self, model, ax):
        ...
        init_apf__srv_name = "/init_apf_srv"
    ...
    def apf_srv_callback(self, req):
        ...
        # robot object
        robot = Robot(self.model, xs, ys, id, name, heading, xt, yt) 
        ...
        InitRobotAcion(self.model, robot, self.ax)
