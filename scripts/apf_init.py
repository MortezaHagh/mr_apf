...
class Run():
    def __init__(self):
        ...
        # # results
        self.test = "T1"
        self.dir_p = "/home/morteza/catkin_ws/src/apf/results/" + self.test + "/apf_paths.json"
        self.dir_t = "/home/morteza/catkin_ws/src/apf/results/" + self.test + "/apf_times.json"
        self.dir_f = "/home/morteza/catkin_ws/src/apf/results/" + self.test + "/apf_paths"
